#!/usr/bin/env python3
"""
Test script to verify invoice API functionality
"""
...
def test_invoice_api():
    print("Testing Invoice API Functionality...")
    ...
    # Step 4: Test GET pending invoices
    print("\n4. Testing GET /api/invoices/pending...")
    try:
    ...
    # Step 5: Test GET overdue invoices
