...
export function portalClasses(isLight) {
  return {
    ...
    textMuted: isLight ? 'text-slate-500' : 'text-white/65',
    ...
    cardHover: isLight
      ? 'hover:border-[color:var(--portal-accent)] hover:shadow-md'
      : 'hover:border-[color:var(--portal-accent-ring)] hover:bg-white/[0.06]',
    input: isLight
      ? 'rounded-xl border border-slate-200 bg-slate-50 text-slate-900 placeholder:text-slate-400 focus:border-[color:var(--portal-accent)] focus:ring-2 focus:ring-[color:var(--portal-accent-ring)]'
      : 'rounded-xl border border-white/15 bg-black/30 text-white placeholder:text-white/30 focus:border-[color:var(--portal-accent)] focus:ring-2 focus:ring-[color:var(--portal-accent-ring)]',
