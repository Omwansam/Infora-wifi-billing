    ...
    items: [
      {
        ...
        title: 'Getting paid',
        accent: 'paid',
        lead: 'Where money lands and which methods subscribers are offered. M-Pesa credentials are the ones worth checking twice — a wrong shortcode fails silently at 2am.',
      ...
      },
      {
        ...
        sub: 'SMS gateway',
        icon: MessageSquare,
        title: 'Your SMS gateway',
        accent: 'SMS',
        lead: 'The sender that carries receipts, expiry warnings and vouchers. Without it, every notification below is written but never leaves the building.',
