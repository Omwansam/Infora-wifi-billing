...
import MessagingSettings from './tabs/MessagingSettings';
...
function panelFor(id, { admin, go }) {
  switch (id) {
    ...
    case 'sms': return <MessagingSettings channel="sms" />;
    case 'email': return <EmailSettings />;
    case 'whatsapp': return <MessagingSettings channel="whatsapp" />;
