...
export const API_ENDPOINTS = {
  ...
  deviceJobs: (deviceId) => `${API_BASE_URL}/api/devices/${deviceId}/jobs`,
  deviceJob: (deviceId, jobId) => `${API_BASE_URL}/api/devices/${deviceId}/jobs/${jobId}`,
  ...
  importRunCutover: (runId) => `${API_BASE_URL}/api/import/runs/${runId}/cutover`,
  importRunCutoverReset: (runId) => `${API_BASE_URL}/api/import/runs/${runId}/cutover-reset`,
  importRunVerify: (runId) => `${API_BASE_URL}/api/import/runs/${runId}/verify`,
  importRunWatch: (runId) => `${API_BASE_URL}/api/import/runs/${runId}/watch`,
